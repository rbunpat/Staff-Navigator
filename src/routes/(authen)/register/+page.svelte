      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                  ...
                  <div>
                    <span class="font-medium">Missing Info</span> Please fill out all fields.
                  </div>
                </div>
              ...
              <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                  ...
                  <span class="sr-only">Info</span>
                  <div>
                    <span class="font-medium">Human Validation Error</span> Please try again.
                  </div>
                </div>
              ...
              <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                  ...
                  <span class="sr-only">Info</span>
                  <div>
                    <span class="font-medium">Error</span> Email/Username already exists.
                  </div>
                </div>
              ...
              <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                  ...
                  <span class="sr-only">Info</span>
                  <div>
                    <span class="font-medium">Error</span> This cane is already registered.
                  </div>
                </div>
              ...
              <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                  ...
                  <span class="sr-only">Info</span>
                  <div>
                    <span class="font-medium">Error</span> Passwords do not match.
                  </div>
                </div>
              ...
              <form class="space-y-4 md:space-y-6" method="POST" action="?/register">
                  ...
                  <div>
                    <label for="caneserial" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cane Serial Number</label>
                    <input type="number" name="caneserial" id="caneserial" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123456" required="">
                </div>
